...
public class DamageService {
    ...
    public Damage logDamage(InspectionRequest request) {
        ...
        damage.setPenaltyAmount(penalty);
        damage.setReportedDate(LocalDate.now());
    ...
    private double calculatePenalty(String severity) {
        ...
        switch (severity.toUpperCase()) {
            case "LOW": return PENALTY_LOW;
            case "MEDIUM": return PENALTY_MEDIUM;
            case "HIGH": return PENALTY_HIGH;
            default: return 0;
        }
    }
}
